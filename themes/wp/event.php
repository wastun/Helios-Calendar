...
?>
	...
	<section>
		<article itemscope itemtype="http://schema.org/Event">
			...
			<div id="evernote">
				<div id="location" itemscope itemprop="location" itemtype="http://schema.org/Place">
					<h2 itemprop="name" class="location"><?php echo $myEvnt['Venue_Name'];?>
					...
					<a href="'.$myLnks['Venue_Directions'].'" target="_blank" itemprop="geo" itemscope itemtype="http://schema.org/GeoCoordinates">
		...
		<?php	if($myEvnt['VenueID'] > 0 && $myEvnt['Venue_Lat'] != '' && $myEvnt['Venue_Lon'] != ''){?>
